...
def main():
    ...
    if flask.request.method == 'POST':
        ...
        if '5 AND ABOVE' in set(data.NO_OF_DEPENDENT.unique()):
        ...
        str1='LIST OF HIGH ATTRITION RISK'        
        return flask.render_template('main.html', prediction0=a0, s1=str1)    
